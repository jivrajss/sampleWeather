...
package com.research.jugnig.weatherservice.sync.utils;
...
import com.research.jugnig.weatherservice.sync.feed.FeedContract;
...
public class SyncUtils {
    ...
    public static void TriggerRefresh() {
        Log.d("Syncutils", "from TriggerRefresh.....");
        Bundle b = new Bundle();
